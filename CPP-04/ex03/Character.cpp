...
Character::Character(const Character &other): _name(other._name), slots_used(other.slots_used), saved_materias(other.saved_materias)
{
    floor = new AMateria*[saved_materias];
...
void Character::equip(AMateria* m)
{
    ...
    inventory[i] = m;
    std::cout << "[Character]" << _name << " equip Materia "<< m->getType() << std::endl;
    slots_used++;
}
